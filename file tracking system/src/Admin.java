...
public class Admin {
	...
	public JFrame frmFileTrackingSystem;
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					window.getFrmFileTrackingSystem().setEnabled(true);
	...
	private  void initialize() throws SQLException  {
		...
		JMenu mnGenerateReport = new JMenu("GENERATE REPORT");
		mnGenerateReport.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent arg0) {
				Report opn;
				try {
					opn = new Report();
					opn.frame.setVisible(true);
					frmFileTrackingSystem.setVisible(false);
		...
		mnGenerateReport.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
		...
		mnGenerateReport.setForeground(Color.WHITE);
		mnGenerateReport.setFont(new Font("Times New Roman", Font.BOLD, 16));
		menuBar.add(mnGenerateReport);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					...
					//frmFileTrackingSystem.setEnabled(false);
